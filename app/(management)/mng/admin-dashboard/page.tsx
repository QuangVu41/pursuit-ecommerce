...
import AdminDashboardWrapper from '@/components/management/dashboard/AdminDashboardWrapper';
import FilterHeader from '@/components/management/filter/FilterHeader';
import { checkUserHasAdminRole } from '@/lib/auth-helper';
import { adminDashboardSortBy } from '@/lib/searchParams';
  ...
  return (
    <>
      ...
      <Suspense key={JSON.stringify(queryParams)} fallback={<LoadingPage />}>
        <AdminDashboardWrapper searchParams={queryParams} />
      </Suspense>
    </>
  );
};
